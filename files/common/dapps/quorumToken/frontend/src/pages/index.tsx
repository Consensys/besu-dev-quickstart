...
import ReadBesuToken from "../components/besuToken/ReadBesuToken";
import TransferBesuToken from "../components/besuToken/TransferBesuToken";
...
export default function Home() {
  ...
  return (
    <>
      <Heading as="h3" my={4}>BesuToken</Heading>          
      <VStack>
      <Box w='100%' my={4}>
        {currentAccount  
        ...
        {(erc20ContractAddress!="0x")  
          ...
          <Heading my={4} fontSize='xl'>Read BesuToken</Heading>
        ...
        {(erc20ContractAddress!="0x")  
          ?<Box  mb={0} p={4} w='100%' borderWidth="1px" borderRadius="lg">
          <Heading my={4}  fontSize='xl'>Transfer BesuToken</Heading>
