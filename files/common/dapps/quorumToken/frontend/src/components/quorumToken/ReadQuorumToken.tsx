...
import {BesuTokenABI as abi} from './BesuTokenABI';
import {ethers, Contract} from 'ethers';

declare let window: any;

interface ReadBesuTokenProps {
 ...
 * @param props
 */
export default function ReadBesuToken(props:ReadBesuTokenProps){
  ...
  return (
    <div>
        ...
        <Text><b>BesuToken totalSupply</b>: {totalSupply} {symbol}</Text>
        <Text><b>BesuToken in current account</b>: {balance} {symbol}</Text>
    </div>
  );
}
